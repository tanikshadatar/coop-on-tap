  ...
  const projects=[
    {fc:"#4B7A00",coin:"assets/flavor-lime.png",flavor:"Key Lime",ribbon:"The Big Win",rcls:"r-blue",
     ...
     impact:"Anyone in tech support can pull a machine's full service history in seconds, instead of digging through Zendesk tickets and alerts by hand to get up to speed.",
    ...
    {fc:"#246EFF",coin:"assets/flavor-pom-blueberry.png",flavor:"Pomegranate Blueberry",ribbon:"Under the Hood",rcls:"r-blue",
     ...
     impact:"Service-call recaps come out cleaner and the recording links work in production again, so the team can actually trust what the summarizer puts out.",
    ...
    {fc:"#C8102E",coin:"assets/flavor-watermelon.png",flavor:"Watermelon",ribbon:"New: Growth",rcls:"r-red",
     ...
     impact:"Sales can start with the existing accounts most likely to grow, instead of guessing which customers to chase next. It points straight at this year's growth goals.",
     did:"Built an early model that scores each expansion account by how likely it is to grow, so the strongest opportunities rise to the top. Still an MVP, but it gives sales a ranked starting point instead of a blank page.",
    ...
    {fc:"#FA5D05",coin:"assets/flavor-mango.png",flavor:"Peach Mango",ribbon:"Day-to-day",rcls:"r-orange",
     ...
     impact:"This is where I picked up the foundational data-science skills the rest of my work stands on, writing SQL, modeling data, and learning how a data team actually runs, all while keeping other teams unblocked with the data they needed.",
